...
ldr  r5,=0x03004DF0 @ FE8J 操作キャラのワークメモリへのポインタ
ldr  r5,[r5]
...
MOV r1, #0x80
LSL r1 ,r1 ,#0x4
blh_lr  0x08024908  @FE8J バリスタチェックの続きを行う
cmp r0,#0x1
beq ExitBalista
...
ldrb r0,[r4,#0x01]  @ Table->From Class
...
ldrh r0,[r4,#0x06]  @     W6:SONG=From SE(0=None)
cmp  r0,#0x00
beq  UpdateUnitIcon
...
ExitBalista:
ldr r4,=0x03004DF0 @ FE8J 操作キャラのワークメモリへのポインタ
ldr r0, [r4]       @ 壊すコードの再送(必ずr4にはポインタを入れておくこと)

LDR r3, =0x0802493C @FE8J バリスタから降りる
pop {r5}
mov pc,r3
