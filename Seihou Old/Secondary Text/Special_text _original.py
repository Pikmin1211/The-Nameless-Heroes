...
unit_menu_list=[' Seize',' Attack',' Attack',' Staff',' Ride',' Exit',
                ' Play',' Dance',' Steal',' Summon',' Summon',' Pick',
                ' Talk',' Support',' Visit',' Chest',' Door',' Armory',' Vendor',
                ' Secret',' Arena',' Rescue',' Drop',' Take',' Give',
                ' Item',' Trade',' Supply',' Wait']

main_menu_list=['Unit','Status','Guide','Records','Options','Retreat',
                'Suspend','End']
